const order = [
  {
    ...
    orderItems: [
      {
        ...
        price: "49.99",
        product: { $oid: "6175f9bbfbf8321a2e4b851a" },
        _id: { $oid: "617628bb6acea4f0f1aa97b2" },
      },
    ],
    shippingAddress: {
      fullname: "Van Nguyen Nguyen",
      phone: "234234",
      address: "fghfgh",
      city: "fghfghfgh",
      postalCode: "2204",
    ...
    paymentResult: {
      id: "7HC74348DW648272E",
      status: "COMPLETED",
      update_time: "2021-10-25T05:52:42Z",
      email_address: "sb-sof6f8149466@personal.example.com",
    },
...

  {
    ...
    orderItems: [
      {
        ...
        price: "399.99",
        product: { $oid: "6175f9bbfbf8321a2e4b850d" },
        _id: { $oid: "6177a5e9d3ec69c9030fe39a" },
      },
    ],
    shippingAddress: {
      fullname: "Van Nguyen Nguyen",
    ...
    paymentResult: {
      id: "20G761490A1909322",
      status: "COMPLETED",
      update_time: "2021-10-26T06:53:43Z",
      email_address: "sb-sof6f8149466@personal.example.com",
    },
